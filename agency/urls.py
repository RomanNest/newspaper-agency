...
urlpatterns = [
    ...
    path("topics/create/", TopicCreateView.as_view(), name="topics_create"),
    path("topics/<int:pk>/update/", TopicUpdateView.as_view(), name="topics_update"),
    path("topics/<int:pk>/delete/", TopicDeleteView.as_view(), name="topics_delete"),
]
